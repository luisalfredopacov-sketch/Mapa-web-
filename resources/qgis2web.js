...
map.getView().fit([-8498378.017938, -2750423.604040, -5669868.054471, -910314.229704], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAPA WEB</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (35 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Practica de realizacion de mapa web';
            }
